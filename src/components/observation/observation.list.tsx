...
export const ObservationList = () => {
    ...
    return (
        <section>
            <article>
                <div className="alert alert-secondary" role="alert"><h5>Observation List</h5></div>
                ...
                <button onClick={retrieveAllItem} className="w-20 btn btn-secondary button btn-sm" >Retrieve</button>
