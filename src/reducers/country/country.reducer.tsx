...
export const countryReducer = (state: stateReducer<Country> = initialState, action: createStart | createSuccess<Country> | createError | createAllStart | createAllSuccess<Country> | createAllError | retrieveAllStart | retrieveAllSuccess<Country> | retrieveAllError | retrieveStart | retrieveSuccess<Country> | retrieveError | updateStart | updateSuccess<Country> | updateError | deleteStart | deleteSuccess<Country> | deleteError ): stateReducer<Country> => {
    switch (action.type) {
